...
DECLARE
    CURSOR curHub IS SELECT codHub FROM hub;
...
BEGIN
    ...
    -- ## tabela Hub ##
    INSERT INTO hub(codHub, hub, tipoHub) VALUES ( 1, 'CT01', 'E' );
    INSERT INTO hub(codHub, hub, tipoHub) VALUES ( 2, 'CT02', 'E' );
    INSERT INTO hub(codHub, hub, tipoHub) VALUES ( 3, 'CT03', 'E' );
    INSERT INTO hub(codHub, hub, tipoHub) VALUES ( 4, 'CT04', 'P' );
    INSERT INTO hub(codHub, hub, tipoHub) VALUES ( 5, 'CT05', 'P' );
    INSERT INTO hub(codHub, hub, tipoHub) VALUES ( 6, 'CT06', 'E' );


    OPEN curHub;
        LOOP
        FETCH curHub INTO vCodHub;
        EXIT WHEN curHub%NOTFOUND; 
        -- ## tabela Venda ##
                ...
                FOR contadorTempo IN 1..72
                    LOOP
                        FOR contadorProduto IN 1..8
                            LOOP
                                INSERT INTO venda(codCliente, codProduto, codTempo, codHub, vendasLiquidas, quantidade) 
                                VALUES (contadorCliente, contadorProduto, contadorTempo, vCodHub, ROUND(DBMS_RANDOM.VALUE(1, 50)), ROUND(DBMS_RANDOM.VALUE(1, 9999)));
                            END LOOP;
                    END LOOP;
            END LOOP;
        END LOOP;
